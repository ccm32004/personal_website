...
const SOCIAL_LINKS = [
  {
    name: 'GitHub',
    url: 'https://github.com/ccm32004', // Replace with your GitHub profile
    icon: (
  ...
  {
    name: 'LinkedIn',
    url: 'https://linkedin.com/in/cc-yuqing-ma/', // Replace with your LinkedIn profile
    icon: (
  ...
  {
    name: 'Email',
    url: 'mailto:mayuqing13@gmail.com', // Replace with your email
    icon: (
